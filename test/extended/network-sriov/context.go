...
func InSRIOVProvisionedContext(body func()) {
	Context("SRIOV is provisioned on each worker node", func() {
		BeforeEach(func() {
...
func InSRIOVDeployedContext(body func()) {
	Context("SRIOV is deployed", func() {
		BeforeEach(func() {
